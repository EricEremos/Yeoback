...
This source snapshot contains development version 0.3.5 (9). See [documented safety limits](docs/github/SAFETY.md); the local preview is not notarized or independently security-certified.
